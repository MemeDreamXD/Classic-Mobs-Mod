...
public class CraftingGen extends RecipeProvider {
	...
	protected void buildRecipes() {
		...
		ShapedRecipeBuilder.shaped(getter, RecipeCategory.BUILDING_BLOCKS, ModBlocks.PALM_WOOD, 3)
				.pattern("ll")
				.pattern("ll")
				.define('l', ModBlocks.PALM_LOG)
                .unlockedBy("has_log", has(ModBlocks.PALM_LOG))
				.save(this.output);

        ShapedRecipeBuilder.shaped(getter, RecipeCategory.BUILDING_BLOCKS, ModBlocks.STRIPPED_PALM_WOOD, 3)
                .pattern("ll")
                .pattern("ll")
                .define('l', ModBlocks.STRIPPED_PALM_LOG)
                .unlockedBy("has_log", has(ModBlocks.STRIPPED_PALM_LOG))
                .save(this.output);

        ShapelessRecipeBuilder.shapeless(getter, RecipeCategory.BUILDING_BLOCKS, ModBlocks.PALM_PLANKS, 4)
