package com.memedream.classicmobs.util;
	...
	public static String convertMessageFormatCode(LangFormatSplitter.MessageFormatComponent component) {
		...
		if (formatStyle != null && component.isChoice()) {
			...
			try {
				...
				ClassicMobs.LOGGER.warn("Failed to convert '{}' to an upside down choice format. Got: '{}' which was invalid.", formatStyle, newFormatStyle);
