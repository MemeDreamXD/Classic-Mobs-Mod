...
public class ModFoodProperties {
    ...
    public static final FoodProperties RAW_CHICKEN_BLOCK = new FoodProperties.Builder().nutrition(18).saturationModifier(2.7F).usingConvertsTo(Items.BONE).effect(() -> new MobEffectInstance(MobEffects.HUNGER, 600, 9), 0.3F).build();
