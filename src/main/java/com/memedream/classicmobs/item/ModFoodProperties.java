...
public class ModFoodProperties {
    ...
    public static final FoodProperties ROTTEN_FLESH_BLOCK = new FoodProperties.Builder().nutrition(36).saturationModifier(0.9f).effect(() -> new MobEffectInstance(MobEffects.HUNGER, 600, 7), 1.0f).build();
}
