...
public class AntlionModel extends HierarchicalModel<AntlionEntity> {
    ...
    public static LayerDefinition create() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(50, 0).addBox(-1.0F, -6.0F, -1.0F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, 24.0F, -5.0F));
        ...
        PartDefinition jaw1 = partdefinition.addOrReplaceChild("jaw1", CubeListBuilder.create().texOffs(0, 24).addBox(-4.0F, -4.0F, -12.0F, 4.0F, 4.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(0, 40).addBox(-6.0F, -4.0F, -12.0F, 2.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 24.0F, -5.0F, 0.0F, -0.6109F, 0.0F));
        ...
        PartDefinition jaw2 = partdefinition.addOrReplaceChild("jaw2", CubeListBuilder.create().texOffs(32, 24).addBox(0.0F, -2.0F, -12.0F, 4.0F, 4.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(28, 40).addBox(4.0F, -2.0F, -12.0F, 2.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 22.0F, -5.0F, 0.0F, 0.6109F, 0.0F));
        ...
        PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create(), PartPose.offset(-13.0F, 24.0F, 14.0F));
        ...
        PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create(), PartPose.offset(13.0F, 24.0F, 14.0F));
        ...
        PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create(), PartPose.offset(-13.0F, 24.0F, 8.0F));
        ...
        PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create(), PartPose.offset(13.0F, 24.0F, 8.0F));
        ...
        PartDefinition leg5 = partdefinition.addOrReplaceChild("leg5", CubeListBuilder.create(), PartPose.offset(-13.0F, 24.0F, 3.0F));
        ...
        PartDefinition leg6 = partdefinition.addOrReplaceChild("leg6", CubeListBuilder.create(), PartPose.offset(13.0F, 24.0F, 3.0F));
