...
public class AntlionModel extends HierarchicalModel<AntlionEntity> {
    ...
    public static LayerDefinition create() {
        ...
        PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create(), PartPose.offset(-5.0F, 21.0F, 14.0F));
        ...
        PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create(), PartPose.offset(5.0F, 21.0F, 14.0F));
        ...
        PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create(), PartPose.offset(-5.0F, 22.0F, 9.0F));
        ...
        PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create(), PartPose.offset(5.0F, 22.0F, 9.0F));
        ...
        PartDefinition leg5 = partdefinition.addOrReplaceChild("leg5", CubeListBuilder.create(), PartPose.offset(-5.0F, 23.0F, 4.0F));
        ...
        PartDefinition leg6 = partdefinition.addOrReplaceChild("leg6", CubeListBuilder.create(), PartPose.offset(5.0F, 23.0F, 4.0F));
