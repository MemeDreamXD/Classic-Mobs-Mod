...
public class RocketCreeperModel extends HierarchicalModel<RocketCreeperEntity> {
    ...
    @Override
    public void setupAnim(RocketCreeperEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
