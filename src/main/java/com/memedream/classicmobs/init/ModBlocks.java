...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> COOKED_DODO_BLOCK = registerWithItem("cooked_dodo_block", properties -> new MeatBlock(MeatBlock.BoneType.NORMAL, properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.NETHER).instrument(NoteBlockInstrument.COW_BELL).strength(2.0F).sound(SoundType.FROGSPAWN), () -> new Item.Properties().useBlockDescriptionPrefix().food(ModFoodProperties.COOKED_DODO_BLOCK, ModFoodProperties.DEFAULT_MEAT_CONSUMABLE).usingConvertsTo(Items.BONE));
    ...
    public static final DeferredBlock<Block> RAW_DODO_BLOCK = registerWithItem("raw_dodo_block", properties -> new RawMeatBlock(COOKED_DODO_BLOCK, MeatBlock.BoneType.NORMAL, properties), () -> BlockBehaviour.Properties.of().mapColor(MapColor.NETHER).instrument(NoteBlockInstrument.COW_BELL).strength(2.0F).sound(SoundType.FROGSPAWN), () -> new Item.Properties().useBlockDescriptionPrefix().food(ModFoodProperties.RAW_DODO_BLOCK, ModFoodProperties.DEFAULT_MEAT_CONSUMABLE).usingConvertsTo(Items.BONE));
