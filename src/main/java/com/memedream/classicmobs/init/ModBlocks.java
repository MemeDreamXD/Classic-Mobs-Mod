...
public class ModBlocks {
    ...
    public static final DeferredBlock<HorizontalDirectionalBlock> CARVED_UNDERSHALE_TILE_CORNER = registerWithItem("carved_undershale_tile_corner", TileBlockCorner::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).strength(4.5F, 6.0F).sound(SoundType.DEEPSLATE));
    public static final DeferredBlock<HorizontalDirectionalBlock> CARVED_UNDERSHALE_TILE_STRAIGHT = registerWithItem("carved_undershale_tile_straight", TileBlockStraight::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).strength(4.5F, 6.0F).sound(SoundType.DEEPSLATE));
    public static final DeferredBlock<HorizontalDirectionalBlock> CARVED_UNDERSHALE_TILE = registerWithItem("carved_undershale_tile", TileBlock::new, () -> BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).requiresCorrectToolForDrops().instrument(NoteBlockInstrument.BASEDRUM).strength(4.5F, 6.0F).sound(SoundType.DEEPSLATE));
