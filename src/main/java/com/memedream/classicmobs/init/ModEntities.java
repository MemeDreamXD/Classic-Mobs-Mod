...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<AntlionEntity>> ANTLION = registerWithEgg("antlion", EntityType.Builder.of(AntlionEntity::new, MobCategory.MONSTER).notInPeaceful().sized(1.4F, 0.7F), AntlionEntity::createAttributes, null);
    public static final DeferredHolder<EntityType<?>, EntityType<MyrmexEntity>> MYRMEX = registerWithEgg("myrmex", EntityType.Builder.of(MyrmexEntity::new, MobCategory.MONSTER).notInPeaceful().sized(0.7F, 1.95F), MyrmexEntity::createAttributes, null);
    public static final DeferredHolder<EntityType<?>, EntityType<HagEntity>> HAG = registerWithEgg("hag", EntityType.Builder.of(HagEntity::new, MobCategory.MONSTER).notInPeaceful().sized(0.8F, 1.1F), HagEntity::createAttributes, null);
    public static final DeferredHolder<EntityType<?>, EntityType<HarpyEntity>> HARPY = registerWithEgg("harpy", EntityType.Builder.of(HarpyEntity::new, MobCategory.MONSTER).notInPeaceful().sized(0.8F, 1.6F), HarpyEntity::createAttributes, null);
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ThrownKnifeEntity>> THROWN_KNIFE = registerMisc("thrown_knife", EntityType.Builder.<ThrownKnifeEntity>of(ThrownKnifeEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).noSummon().clientTrackingRange(4).updateInterval(20));
